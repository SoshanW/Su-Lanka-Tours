...
const TESTIMONIALS = [
  {
    ...
    testimonial: "The team at Su Lanka lead by Anishka are amazing. They pulled out all the stops to come up with a great value for money for itinerary for sush a fussy customer...",
    rating: 5,
  },
  {
    id: 2,
    ...
    testimonial: "Very good experience and support provided by SuLanka tours to organise a tailored visit of Sri Lanka. It has been very easy to adjust the tour until the last week before we arrived with Anishka (great flexibility).",
    rating: 5,
  },
  {
    id: 3,
    ...
    testimonial: "We had a fantastic trip to Sri Lanka in February with Sudath as our driver. Communicating with Sudath before the trip to plan everything was very easy and Sudath replied incredibly fast to every email/whatsapp. We had an idea of our itinerary and Sudath was great at helping...",
    rating: 5,
  },
];
