                  ...
                  >
                    ...
                    <div>
                      ...
                      <a 
                        ...
                        className="text-white font-medium text-lg hover:text-secondary transition-colors group flex items-center mt-2"
                      >
                        +94 77 446 9122
                        <ExternalLink size={14} className="ml-2 opacity-0 group-hover:opacity-100 transition-opacity" />
                      </a>
                  ...
                  <div className="flex space-x-4">
                    {[
                      ...
                      <motion.a
                        key={platform}
                        href={url}
                        target={platform === 'facebook' || platform === 'instagram' || platform === 'whatsapp' ? "_blank" : "_self"}
                        rel={platform === 'facebook' || platform === 'instagram' || platform === 'whatsapp' ? "noopener noreferrer" : ""}
